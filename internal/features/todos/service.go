...
type (
	Service interface {
		...
		Add(ctx context.Context, title, description string) (*domain.Todo, error)
		// Remove removes a todo from the list
		Remove(ctx context.Context, id uuid.UUID) error
		// Update updates a todo in the list
		Update(ctx context.Context, id uuid.UUID, completed bool, title, description string) (*domain.Todo, error)
...
func (s service) Add(_ context.Context, title, description string) (*domain.Todo, error) {
	todo := s.todos.Add(title, description)
...
func (s service) Update(_ context.Context, id uuid.UUID, completed bool, title, description string) (*domain.Todo, error) {
	todo := s.todos.Update(id, completed, title, description)
