...
func Test_service_Add(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Add": {
			...
			mock: func(f fields) {
				f.todos.EXPECT().Add("title", "description").Return(todo)
			},
			want:    todo,
			wantErr: false,
		},
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			...
			got, err := s.Add(tt.args.ctx, tt.args.title, tt.args.description)
...
func Test_service_Update(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"UpdateNotFound": {
			...
			mock: func(f fields) {
				f.todos.EXPECT().Update(todoID, true, "updated", "updated").Return(nil)
			},
			want:    nil,
			wantErr: false,
		},
		"UpdateFound": {
			...
			mock: func(f fields) {
				f.todos.EXPECT().Update(todoID, true, "updated", "updated").Return(updated)
			},
			want:    updated,
			wantErr: false,
		},
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			...
			got, err := s.Update(tt.args.ctx, tt.args.id, tt.args.completed, tt.args.description, tt.args.description)
			if (err != nil) != tt.wantErr {
