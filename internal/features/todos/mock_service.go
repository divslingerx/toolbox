...
// Add provides a mock function with given fields: ctx, title, description
func (_m *MockService) Add(ctx context.Context, title string, description string) (*domain.Todo, error) {
	...
	var r0 *domain.Todo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*domain.Todo, error)); ok {
		return rf(ctx, title, description)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *domain.Todo); ok {
...
//   - title string
//   - description string
func (_e *MockService_Expecter) Add(ctx interface{}, title interface{}, description interface{}) *MockService_Add_Call {
	return &MockService_Add_Call{Call: _e.mock.On("Add", ctx, title, description)}
}

func (_c *MockService_Add_Call) Run(run func(ctx context.Context, title string, description string)) *MockService_Add_Call {
...
func (_c *MockService_Add_Call) RunAndReturn(run func(context.Context, string, string) (*domain.Todo, error)) *MockService_Add_Call {
	_c.Call.Return(run)
	return _c
}
...
// Update provides a mock function with given fields: ctx, id, completed, title, description
func (_m *MockService) Update(ctx context.Context, id uuid.UUID, completed bool, title string, description string) (*domain.Todo, error) {
	ret := _m.Called(ctx, id, completed, title, description)
	...
	var r0 *domain.Todo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool, string, string) (*domain.Todo, error)); ok {
		return rf(ctx, id, completed, title, description)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool, string, string) *domain.Todo); ok {
		r0 = rf(ctx, id, completed, title, description)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.Todo)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, bool, string, string) error); ok {
		r1 = rf(ctx, id, completed, title, description)
	} else {
		r1 = ret.Error(1)
	}
...
//   - title string
//   - description string
func (_e *MockService_Expecter) Update(ctx interface{}, id interface{}, completed interface{}, title interface{}, description interface{}) *MockService_Update_Call {
	return &MockService_Update_Call{Call: _e.mock.On("Update", ctx, id, completed, title, description)}
}

func (_c *MockService_Update_Call) Run(run func(ctx context.Context, id uuid.UUID, completed bool, title string, description string)) *MockService_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_Update_Call) RunAndReturn(run func(context.Context, uuid.UUID, bool, string, string) (*domain.Todo, error)) *MockService_Update_Call {
	_c.Call.Return(run)
	return _c
}
