...
// Add provides a mock function with given fields: title, description
func (_m *MockTodoRepository) Add(title string, description string) *Todo {
	...
	var r0 *Todo
	if rf, ok := ret.Get(0).(func(string, string) *Todo); ok {
...
//   - title string
//   - description string
func (_e *MockTodoRepository_Expecter) Add(title interface{}, description interface{}) *MockTodoRepository_Add_Call {
	return &MockTodoRepository_Add_Call{Call: _e.mock.On("Add", title, description)}
}

func (_c *MockTodoRepository_Add_Call) Run(run func(title string, description string)) *MockTodoRepository_Add_Call {
...
func (_c *MockTodoRepository_Add_Call) RunAndReturn(run func(string, string) *Todo) *MockTodoRepository_Add_Call {
	_c.Call.Return(run)
	return _c
}
...
// Update provides a mock function with given fields: id, completed, title, description
func (_m *MockTodoRepository) Update(id uuid.UUID, completed bool, title string, description string) *Todo {
	ret := _m.Called(id, completed, title, description)
	...
	var r0 *Todo
	if rf, ok := ret.Get(0).(func(uuid.UUID, bool, string, string) *Todo); ok {
		r0 = rf(id, completed, title, description)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Todo)
		}
...
//   - title string
//   - description string
func (_e *MockTodoRepository_Expecter) Update(id interface{}, completed interface{}, title interface{}, description interface{}) *MockTodoRepository_Update_Call {
	return &MockTodoRepository_Update_Call{Call: _e.mock.On("Update", id, completed, title, description)}
}

func (_c *MockTodoRepository_Update_Call) Run(run func(id uuid.UUID, completed bool, title string, description string)) *MockTodoRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uuid.UUID), args[1].(bool), args[2].(string), args[3].(string))
	})
	return _c
}
...
func (_c *MockTodoRepository_Update_Call) RunAndReturn(run func(uuid.UUID, bool, string, string) *Todo) *MockTodoRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
